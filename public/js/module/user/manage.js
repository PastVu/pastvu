...
define([
    ...
    const ranksLang = {
        mec: 'Patron',
        mec_silv: 'Silver patron',
        mec_gold: 'Gold patron',
        adviser: 'Adviser',
    };
    ...
    return Cliche.extend({
        ...
        create: function () {
            ...
            this.roles = [
                ...
                { cat: 'sadm', name: 'Super administrator' },
            ];
            ...
            this.photoNewLimitOrigin = ko.observable(i18n('Auto'));
        ...
        setRules: function (rules, info) {
            if (_.isNumber(rules.photoNewLimit)) {
                ...
                this.photoNewLimitOrigin(i18n('Auto'));
            }
            ...
            if (!this.regselectVM) {
                renderer(
                    [{
                        ...
                        modal: {
                            topic: i18n('Edit moderated regions list'),
                            initWidth: '900px',
                            maxWidthRatio: 0.95,
                            fullHeight: true,
                            withScroll: true,
                            ...
                            btns: [
                                {
                                    css: 'btn-success', text: i18n('Apply'), glyphicon: 'glyphicon-ok',
                                    click: function () {
                                        const regions = this.regselectVM.getSelectedRegions(['cid', 'title_en', 'title_local']);

                                        if (regions.length > 20) {
                                            return noties.alert({
                                                message: i18n('Up to 20 regions may be selected'),
                                                type: 'warning',
                                                timeout: 3000,
                                            });
                                        }
        ...
        changenophotostatus: function (data, evt) {
            this.changeRestrictions('nophotostatus', !isYes(evt), true);
        },

        changenologin: function (data, evt) {
        ...
        changenocomments: function (data, evt) {
            this.changeRestrictions('nocomments', !isYes(evt), true);
        },
