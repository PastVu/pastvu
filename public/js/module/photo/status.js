...
define(['underscore'], function (_) {
    ...
    var statuses = {
        ...
        DEACTIVATE: { // Деактивировано
            ...
            title_owner: 'Ваша фотография деактивирована. Только вы и модераторы можете видеть изображение и редактировать страницу',
        ...
        REMOVE: { // Удалено
            ...
            title_owner: 'Ваша фотография удалена.<br>Только вы можете видеть изображение и только администрация может редактировать информацию на этой странице',
