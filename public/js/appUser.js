...
require([
    ...
    'Params', 'globalVM', 'RouteManager', 'renderer', 'text!tpl/appUser.jade', 'css!style/appUser', 'backbone.queryparams', 'knockout.extends', 'noty', 'noty.layouts/center', 'noty.themes/oldmos'
