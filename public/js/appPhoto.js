...
require([
    ...
    'Params', 'globalVM', 'RouteManager', 'renderer', 'text!tpl/appPhoto.jade', 'css!style/appPhoto', 'momentlang/ru', 'backbone.queryparams', 'bs/bootstrap-transition', 'knockout.extends', 'noty', 'noty.layouts/center', 'noty.themes/oldmos'
        ...
        return {
            ...
            handlers: {
                photo: function (cid, getParams) {
                    this.params({photo: cid || "", comment: getParams && getParams.comment, frag: getParams && getParams.frag});
