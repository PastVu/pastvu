...
var ChatSchema = new Schema(
		{
			...
			admins: [ //Пользователи, имеющие возможность управлять мультичатом (закрыть, добавить/удалить пользователя и т.д.), обязателен хотя бы один пользователь, по умолчанию автор
				{type: Schema.Types.ObjectId, ref: 'User'}
			],
			members: [ //Текущие участники, которые читают чат
				{type: Schema.Types.ObjectId, ref: 'User'}
			],
			members_off: [ //Участники, покинувшие мультичат, но имеющие возможность самостоятельно присоединиться
				{type: Schema.Types.ObjectId, ref: 'User'}
			],
			members_del: [ //Удаленные владельцем участники мультичата, не могут вернуться сами
				{type: Schema.Types.ObjectId, ref: 'User'}
			]
		},
